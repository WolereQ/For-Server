...
public class ChatCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender snd, Command cmd, String l, String[] args) {
		...
		if(cmd.getName().equalsIgnoreCase("voucher")){
			...
			Bukkit.broadcastMessage(ChatColor.RED + "" + ChatColor.BOLD + "VOUCHER" + ChatColor.DARK_GRAY + "» " + 
			ChatColor.RED + args[0]  + " wpisz ten kod na stronie: " + ChatColor.GOLD + "http://www.97328.enmc.pl/" + ChatColor.RED + " w zakładce z ranga i trybem voucher");
